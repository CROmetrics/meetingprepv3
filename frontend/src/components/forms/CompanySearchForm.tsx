  ...
  return (
    <div className="space-y-4">
      <div className="relative">
        <label htmlFor="company-search" className="block text-sm font-medium text-cro-soft-black-700 mb-2">
          Search for Company
        </label>
          ...
          <div className="absolute z-10 mt-1 w-full bg-white border border-cro-plat-300 rounded-xl shadow-lg max-h-64 overflow-y-auto">
            {searchResults.map((company) => (
              <button
                ...
                className="w-full text-left px-4 py-3 hover:bg-cro-blue-50 focus:bg-cro-blue-50 focus:outline-none
                         border-b border-cro-plat-200 last:border-b-0"
              >
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-cro-soft-black-600 mt-1 space-y-1">
                  {selectedCompany.domain && (
                    <div><span className="font-medium">Domain:</span> {selectedCompany.domain}</div>
                  )}
                  ...
                  {selectedCompany.numberofemployees && (
                    <div><span className="font-medium">Employees:</span> {selectedCompany.numberofemployees}</div>
                  )}
                </div>
              </div>
            </div>
